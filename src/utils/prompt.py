...
def get_cuisine_info_prompt(history_context, rag_context, mess):
    return (
        ...
        "ЕСЛИ ЗАПРОС — ЭТО БЛЮДО (например: «пельмени», «паэлья», «суши»):\n"
        "- Попробуй определить, к какой национальной кухне относится это блюдо.\n"
        "- Если блюдо есть в базе — укажи:\n\n"
        "Блюдо: [Название блюда]\n"
        "Относится к: [Название кухни]\n"
        "Краткое описание:\n"
        "[1–2 предложения]\n\n"
        "- НЕ строй структуру «Название кухни: ...», если это одиночное блюдо.\n"
        "- Если нет информации — скажи: «Информации об этом блюде в базе знаний нет.»\n"
        "- НЕ переходи к внешним источникам.\n\n"
